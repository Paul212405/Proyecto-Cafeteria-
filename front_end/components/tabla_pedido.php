...
<div class="col-span-1 shadow-2xl w-full px-5 py-7 block">
    ...
    <div class="flex justify-between pt-6 text-lg">
        ...
        <p>
            ...
            $sql = "SELECT direccion_facturacion FROM tb_cliente WHERE id_cliente = $id_cliente";
            $result = $con->query($sql);
            $cliente = mysqli_fetch_assoc($result);
            echo $cliente['direccion_facturacion'];
            ?>
        </p>
    </div>
    ...
    <a href="./../back_end/controladores/p_finalizar_pedido.php?direccion=<?php echo $cliente['direccion_facturacion']?>" class="w-full text-center">
