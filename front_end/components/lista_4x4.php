...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
    ...
    ?>
        <div class=" block col-span-1 bg-white rounded-b-lg">
            <div class="bg-[url('./../Public/images/productos/te_helado.jpg')] block w-full h-52 sm:h-40 bg-cover" alt="slider_01"></div>
            <div class="block p-6 ">
                <p class="text-lg lg:text-sm font-bold text-center my-3"><a href="#">
                ...
                <p class="text-2xl lg:text-xl font-bold text-start text-blue-800 my-3">
                    S/. <?php echo $productos['precio']; ?></p>
                <div class="block xl:flex justify-between items-center mx-auto">
...
<div class="w-full mx-auto p-3 bg-black">
    <ul class="flex justify-center">
        ...
        ?>
            <li>
                <button onclick="cargarinterfaz('./components/lista_4x4.php?c=<?php echo $c?>&o=<?php echo $o?>&limite=<?php echo $lim?>','contenedor_productos')" 
