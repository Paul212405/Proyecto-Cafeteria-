...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-03-2023 a las 06:59:59
...
--
ALTER TABLE `detalle_pedido`
  MODIFY `id_det_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=300;
