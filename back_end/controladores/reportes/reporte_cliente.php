...
$pdf->Cell(90,8,'Direccion',1,0,'C',1);
$pdf->Cell(75,8,'Email',1,0,'C',1); 
$pdf->Cell(30,8,'Celular',1,1,'C',1);
...
while ($clientes = $result->fetch_array()) {
        $pdf->Cell(60,8,("  ".$clientes['nombres']." ".$clientes['apellidos']),1,0,'L');
        $pdf->Cell(90,8,"  ".$clientes['direccion'],1,0,'L');
        $pdf->Cell(75,8,"  ".$clientes['email'],1,0,'L');
        $pdf->Cell(30,8,($clientes['celular']),1,1,'C');
    }


//$pdf->AddPage(); //Agregar nueva Pagina

$pdf->Output('Resumen_Cliente_'.date('d_m_y').'.pdf', 'I'); 
