...
<div class="z-20 transition-all duration-700 max-lg:flex max-lg:justify-between max-lg:items-center lg:w-72 overflow-y-hidden lg:overflow-y-auto overflow-x-hidden w-full h-16 pb-3 lg:h-full bg-black lg:max-h-screen sticky lg:fixed lg:top-0 -top-1 lg:left-0">
    <div class="max-sm:hidden px-3 pt-2 lg:pt-8">
        <div class="flex items-center justify-center">
            <!--Logo de empresa-->
            <a href="">
                <img src="../Public/images/negocio/logo.png" class="lg:w-32 lg:h-32 w-16 h-16">
            </a>
        </div>
    </div>
    ...
    <div class="px-6 pt-4">
        ...
        <ul class="text-left flex max-sm:justify-between lg:flex-col space-y-2 text-lg">
            <li class="relative max-lg:flex max-lg:justify-start text-gray-500 hover:text-white focus-within:text-white">
                ...
                <button onclick="cargarcomponente('./paginas/resumen.php','contenedor_admin')" class="text-left inline-block w-full lg:py-2 pl-2 lg:pl-8 pr-4 rounded hover:bg-black lg:hover:bg-gray-800 lg:focus:outline-none lg:focus:ring-1 lg:focus:ring-gray-500 focus:bg-black lg:focus:bg-gray-800">Resumen</button>
            </li>
            <li class="">
                    ...
                    <ul id="menu_mantenimiento" class="hidden block z-50 transition-all duration-1000 max-lg:fixed px-2 max-lg:pb-4 text-gray-500 lg:border-l border-gray-700 max-lg:bg-black">
                        <li class="cursor-pointer">
                            <div class="flex justify-start items-center">
                                <img class="w-8 h-8" src="../Public/images/negocio/usuario1.png" />
                        ...
                        <li class="cursor-pointer">
                            <div class="flex justify-start items-center">
                                <img class="w-8 h-8" src="../Public/images/negocio/cliente1.png" />
                        ...
                        <li class="cursor-pointer">
                            <div class="flex justify-start items-center">
                                <img class="w-8 h-8" src="../Public/images/negocio/testimonio1.png" />
                        ...
                        <li class="cursor-pointer">
                            <div class="flex justify-start items-center">
                                <img class="w-8 h-8" src="../Public/images/negocio/productos1.png" />
                        ...
                        <li class="cursor-pointer">
                            <div class="flex justify-start items-center">
                                <img class="w-8 h-8" src="../Public/images/negocio/categoria2.png" />
                        ...
                        <li class="cursor-pointer">
                            <div class="flex justify-start items-center">
                                <img class="w-8 h-8" src="../Public/images/negocio/pedido1.png" />
            ...
            <li class="relative max-lg:flex max-lg:justify-start items-center text-gray-500 hover:text-white focus-within:text-white max-lg:pb-2">
                ...
                <button onclick="cargarcomponente('./paginas/reporte.php','contenedor_admin')" class="text-left inline-block w-full max-lg:pb-1 lg:py-2 lg:pl-8 pl-2 lg:pr-4 rounded hover:bg-black lg:hover:bg-gray-800 focus:outline-none lg:focus:ring-1 focus:bg-black focus:ring-gray-500 lg:focus:bg-gray-800">Reportes</button>
            </li>
        </ul>
    </div>
