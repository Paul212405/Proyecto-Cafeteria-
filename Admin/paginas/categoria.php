...
$sqlpag = "select count(*) as total from tb_categoria";
//Para la paginacion
...
<div class="block ">
    <div class="lg:ml-72 bg-slate-50 h-16 shadow-2xl mb-4 flex justify-between items-center pl-4">
        <div class="flex justify-start items-center gap-4">
            <h1 class="transition-all duration-700 text-left text-xl sm:text-3xl lg:text-4xl font-bold text-red-800">CATEGORIA</h1>
    ...
    <div class="max-lg:mt-10 lg:mr-14 lg:ml-80 sm:mx-10 transition-all duration-1000">
        ...
        <button onclick="cargarcomponente('./paginas/categoria_add.php','contenedor_categoria')" class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 border border-green-500 rounded">
        <i class="fas fa-plus fa-sm"></i> Añadir Categoria
        </button>
        </div>
...
<div class="mx-auto p-3 bg-black lg:mr-14 lg:ml-80 sm:mx-10 transition-all duration-1000">
    <ul class="flex justify-center ">
        ...
        ?>
            <li>
                <button onclick="cargarcomponente('./paginas/categoria.php?limite=<?php echo $lim?>','contenedor_admin')" 
...
<div class="my-10" id="contenedor_categoria">
