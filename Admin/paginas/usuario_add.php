<section class="block">
    <div class="justify-center lg:ml-72 lg:px-5 px-5">
        <div class="flex justify-center items-center mb-4">
            <div class="bg-white rounded-lg shadow-xl grow sm:grow-0 sm:w-[70%] lg:w-[60%]">
                <div class="bg-black w-full rounded-t-lg py-6 shadow-2xl">
                    ...
                    <div class="flex justify-center items-center w-full">
                        <img class="w-32 h-28" src="../Public/images/negocio/usuario1.png" />
                    </div>
                </div>
                <form class=" lg:px-6 px-4 py-5 " method="POST" action="./../back_end/controladores/usuario/p_add_usuario.php">
                    ...
                    <div class="flex justify-between lg:px-0 ">
                        <div class="flex justify-center px-1 flex-1">
                            <button type="submit" name="edit" class="w-full px-4 rounded-lg bg-green-800 py-3  text-sm lg:text-sm font-bold text-white"><i class="fa fa-save mr-2"></i> Guardar Datos</button>
                        </div>
                        <div class="flex justify-center flex-1">
                            <button onclick="cargarcomponente('./paginas/close.php','contenedor_usuario');event.preventDefault();" class="w-full px-4 rounded-lg bg-red-700 py-3 text-sm lg:text-sm font-bold text-white"><i class="fa fa-power-off mr-2"></i> Cancelar</button>
                        </div>
                    </div>
                </form>
