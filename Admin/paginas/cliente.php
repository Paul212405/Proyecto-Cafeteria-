                ...
                ?>
                    <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                        ...
                        <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                            ...
                            <a href="./../back_end/controladores/p_delete_cliente.php?id=<?php echo $clientes['id_cliente']?>" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 border border-red-500 rounded">
