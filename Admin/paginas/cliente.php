...
$sqlpag = "select count(*) as total from tb_cliente";
//Para la paginacion
...
<div class="block ">
    <div class="lg:ml-72 bg-slate-50 h-16 shadow-2xl mb-4 flex justify-between items-center pl-4">
        <div class="flex justify-start items-center gap-4">
            <h1 class="transition-all duration-700 text-left text-xl sm:text-3xl lg:text-4xl font-bold text-red-800">CLIENTE</h1>
    ...
    <div class="max-lg:mt-10 lg:mr-14 lg:ml-80 sm:mx-10 transition-all duration-1000">
        ...
        <button onclick="cargarcomponente('./paginas/cliente_add.php','contenedor_cliente')" class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 border border-green-500 rounded">
        <i class="fas fa-plus fa-sm"></i> Añadir Cliente
        </button>
        </div>
        <table class="min-w-full border-collapse block md:table text-sm">
            <thead class="block md:table-header-group">
                <tr class="border border-grey-500 md:border-none block md:table-row absolute -top-full md:top-auto -left-full md:left-auto  md:relative z-0">
                    <th class="bg-black p-2 text-white font-bold md:border md:border-grey-500 text-center block md:table-cell">Nombres</th>
                    <th class="bg-black p-2 text-white font-bold md:border md:border-grey-500 text-center block md:table-cell">Apellidos</th>
                    <th class="bg-black p-2 text-white font-bold md:border md:border-grey-500 text-center block md:table-cell">Direccion</th>
                    <th class="bg-black p-2 text-white font-bold md:border md:border-grey-500 text-center block md:table-cell">Email</th>
                    <th class="bg-black p-2 text-white font-bold md:border md:border-grey-500 text-center block md:table-cell">Celular</th>
            ...
            <tbody class="block md:table-row-group">
                <?php
                while ($clientes = $result->fetch_array()) {
                ?>
                    <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                        <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">Nombres</span>
                        <?php echo $clientes['nombres']?>
                        </td>
                        <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">Apellidos</span>
                        <?php echo $clientes['apellidos']?>
                        </td>
                        <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">Direccion</span>
                        ...
                        <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">Celular</span>
                        <?php echo $clientes['celular']?>
                        </td>
                        <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                            <span class="inline-block w-1/3 md:hidden font-bold">Operaciones</span>
                            <button onclick="cargarcomponente('./paginas/cliente_edit.php?id=<?php echo $clientes['id_cliente']?>','contenedor_cliente')" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 border border-blue-500 rounded">
                                <i class="fas fa-edit fa-lg"></i></button>
                            <a href="./../back_end/controladores/cliente/p_delete_cliente.php?id=<?php echo $clientes['id_cliente']?>" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 border border-red-500 rounded">
...
<div class="mx-auto p-3 bg-black lg:mr-14 lg:ml-80 sm:mx-10 transition-all duration-1000">
    <ul class="flex justify-center ">
        ...
        ?>
            <li>
                <button onclick="cargarcomponente('./paginas/cliente.php?limite=<?php echo $lim?>','contenedor_admin')" 
...
<div class="my-10" id="contenedor_cliente">
