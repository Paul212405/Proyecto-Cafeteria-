        ...
        <div class="flex justify-center items-center w-full">
            <div class="grid lg:grid-cols-3 grid-cols-2  gap-6">
                <div class="col-span-1 w-full">
                    <div class="flex justify-center items-center flex-wrap w-full lg:px-8 px-5 gap-4">
                        <h1 class="font-dmserif text-2xl font-bold text-red-300 w-full text-center p-2">USUARIOS</h1>
                ...
                <div class="col-span-1 w-full">
                    <div class="flex justify-center items-center flex-wrap w-full lg:px-8 px-5 gap-4">
                        <h1 class="font-dmserif text-2xl font-bold text-red-300 w-full text-center p-2">CLIENTES</h1>
                        <div class="w-full px-4">
                ...
                <div class="col-span-1 w-full">
                    <div class="flex justify-center items-center flex-wrap w-full lg:px-14 px-10 gap-4">
                        <h1 class=" font-dmserif text-2xl font-bold text-red-300 w-full text-center p-2">TESTIMONIOS</h1>
                        <div class="w-full px-4">
                ...
                <div class="col-span-1 w-full">
                    <div class="flex justify-center items-center flex-wrap w-full lg:px-8 px-5 gap-4">
                        <h1 class=" font-dmserif text-2xl font-bold text-red-300 w-full text-center p-2">PRODUCTOS</h1>
                        <div class="w-full px-4">
                ...
                <div class="col-span-1 w-full">
                    <div class="flex justify-center items-center flex-wrap w-full lg:px-8 px-5 gap-4">
                        <h1 class="font-dmserif text-2xl font-bold text-red-300 w-full text-center p-2">CATEGORIAS</h1>
                        <div class="w-full px-4">
                ...
                <div class="col-span-1 w-full">
                    <div class="flex justify-center items-center flex-wrap w-full lg:px-8 px-5 gap-4">
                        <h1 class="font-dmserif text-2xl font-bold text-red-300 w-full text-center p-2">PEDIDOS</h1>
                        <div class="w-full px-4">
